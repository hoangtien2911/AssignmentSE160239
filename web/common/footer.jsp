<%-- 
    Document   : footer
    Created on : Feb 15, 2023, 12:47:14 AM
    Author     : Hp
--%>
            ...
            <div class="row text-white g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                        ...
                        <span class = "fw-light">
                            71 Nguyễn Đức Cảnh, Thành Phố Buôn Ma Thuột, Tỉnh Đăk Lăk, Việt Nam
                        </span>
                    </div>
                    ...
                    <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                        ...
                        <span class = "fw-light">
                            chinnclothings.support@gmail.com
                        </span>
                    </div>
                ...
                <div class = "col-md-6 col-lg-3">
                    ...
                    <div>
                        <ul class = "list-unstyled d-flex">
                            <li>
                                <a href = "https://www.facebook.com/mun.twichan" class = "text-white text-decoration-none text-muted fs-4 me-4">
