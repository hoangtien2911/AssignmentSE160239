 ...
 * @author Hp
 */
public class ViewClothesAdminServlet extends HttpServlet {
    private final String MANAGE_CLOTHES_PAGE = "./admin/manageClothes.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ViewClothesServlet - ClassNotFound" + e.getMessage());        
        } finally {
